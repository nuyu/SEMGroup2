...
<td style="background-color:powderblue"><?php echo '<input type="text" name="mark['.$x.']"'?> value="<?php echo $addmark['mark'] ?>"</td>
<td style="background-color:powderblue"><?php echo '<input type="text" size="30" name="comment['.$x.']"'?> value="<?php echo $addmark['comment'] ?>"</td>
</tr>
